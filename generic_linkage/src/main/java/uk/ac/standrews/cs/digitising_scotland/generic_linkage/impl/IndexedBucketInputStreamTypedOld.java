...
public class IndexedBucketInputStreamTypedOld implements ILXPInputStreamTypedOld {

    private final IBucketTypedOLD bucket;
    private Iterator<File> file_iterator;

    public IndexedBucketInputStreamTypedOld(final IBucketTypedOLD bucket, final Iterator<File> file_iterator) throws IOException {
