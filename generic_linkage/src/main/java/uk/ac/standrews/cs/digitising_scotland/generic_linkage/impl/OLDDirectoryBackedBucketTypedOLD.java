...
public class OLDDirectoryBackedBucketTypedOLD implements IBucketTypedOLD {
     ...
     */
    public OLDDirectoryBackedBucketTypedOLD(final String name, final String base_path) throws IOException {
