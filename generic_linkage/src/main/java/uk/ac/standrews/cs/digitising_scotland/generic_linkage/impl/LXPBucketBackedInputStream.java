...
import uk.ac.standrews.cs.digitising_scotland.generic_linkage.interfaces.LXPInputStream;
...
public class LXPBucketBackedInputStream implements LXPInputStream {

    private final IBucketLXP bucket;
    private File directory;

    public LXPBucketBackedInputStream(final IBucketLXP bucket, final File directory) throws IOException {
