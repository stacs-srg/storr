...
import uk.ac.standrews.cs.digitising_scotland.record_classification.pipeline.main.ClassifyWithExsistingModels;
...
public class ClassifyWithExsistingModelsTest {
    ...
    public void test() throws Exception {
        ...
        CodeDictionary codeDictionary = new CodeDictionary(new File("icdCodes.txt"));
