...
public class NGramSubstrings implements Iterable<TokenSet> {
	 ...
	 * 
	 */
	private List<TokenSet> splitIntoNGrams(final String stringToSplit)
			throws IOException {
	 ...
	 */
	private static void closeStreams(final TokenStream stream)
			throws IOException {
	...
	private static List<TokenSet> createNGrams(final TokenStream nGramStream)
			throws IOException {

		List<TokenSet> grams = new ArrayList<TokenSet>();
		while (nGramStream.incrementToken()) {
			grams.add(new TokenSet(nGramStream.getAttribute(
	...
	private static int calculateLongestGram(final String string)
			throws IOException {
	...
	private static int countNumTokensInStream(final String string)
			throws IOException {
