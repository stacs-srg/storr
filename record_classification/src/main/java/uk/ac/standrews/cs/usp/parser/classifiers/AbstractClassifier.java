...
/**
 * All classifiers should extend this abstract defining training and classification methods.
 *
 * @author jkc25, frjd2
 */
public abstract class AbstractClassifier {
    ...
    /**
     * Creates a default {@link AbstractClassifier} with no {@link VectorFactory}.
     */
    ...
    /**
     * Trains the extending classifier on a {@link Bucket} of {@link Record} objects.
     *
     * @param bucket bucket to train on
     * @throws Exception An exception will be thrown for any number of reasons, including using invalid training data, codes or malformed data
     */
     ...
     * @throws IOException An exception will be thrown for any number of reasons, including using invalid training data, codes or malformed data
     */
     ...
     *
     * @param bucket bucket containing Records to classify
    ...
    /**
     * Classifies a {@link TokenSet} and returns a Mapping of a Code to it's confidence.
     * @param string the TokenSet to classify
     * @return Map<Code, Double> The result of the classification.
     * @throws IOException Indicatte I/O Error
     */
