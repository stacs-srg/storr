...
public class BestConfidenceClassifier extends AbstractClassifier {
	 ...
	 */
	public BestConfidenceClassifier(final String customPropertiesFile,
		...
		this.naiveBayesClassifier = new NaiveBayesClassifier(
				customPropertiesFile, vectorFactory);
		this.olrClassifier = new OLRClassifier(customPropertiesFile,
				vectorFactory);
	}
