...
import uk.ac.standrews.cs.usp.parser.classifiers.ClassificationPipeline;
import uk.ac.standrews.cs.usp.parser.classifiers.NaiveBayesClassifier;
import uk.ac.standrews.cs.usp.parser.classifiers.OLR.OLRClassifier;
import uk.ac.standrews.cs.usp.parser.classifiers.lookup.ExactMatchClassifier;
import uk.ac.standrews.cs.usp.parser.classifiers.lookup.NGramClassifier;
