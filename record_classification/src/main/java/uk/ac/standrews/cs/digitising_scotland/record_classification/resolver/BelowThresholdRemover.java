...
public class BelowThresholdRemover {
     ...
     */
    public <K, V extends Comparable<Q>,Q> MultiValueMap<K, V> removeBelowThreshold(final MultiValueMap<K, V> map, final Q threshold) throws IOException, ClassNotFoundException {
