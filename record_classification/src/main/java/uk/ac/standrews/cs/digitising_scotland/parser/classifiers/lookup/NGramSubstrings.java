...
/**
 * This class creates and stores the nGrams created from a record and provides methods to access those nGrams.
 * @author frjd2
 *
 *TODO error and exception handling
 *TODO general tidying and refactoring for neatness and readability
 *
 *
 */
public class NGramSubstrings implements Iterable<TokenSet> {
    ...
    /**
     * Initalises and {@link NGramSubstrings} object with the input string split into grams.
     * @param inputString the input string to create Ngrams from.
    ...
    /**
     * Initalises and {@link NGramSubstrings} object with the original data of the record split into grams.
     * @param record the input record to create Ngrams from.
     * @throws IOException IO error
     */
    ...
    /**
     * Returns the nGrams for this {@link NGramSubstrings} class as a List of Strings.
     ...
     * @param stringToSplit - the string to be split into nGrams
     * @return ArrayList<String> - an ArrayList of NGrams
     * @throws IOException If the stream cannot read the stringToSplit
     * 
     */
     ...
     * @param string String to create Tokenizer from.
