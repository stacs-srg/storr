...
public class TimeFromCohabitationToMarriageDistribution extends NormalDistribution {
	...
	public static final int mean = (int) (22 * PopulationLogic.DAYS_PER_YEAR);
	
	public TimeFromCohabitationToMarriageDistribution(Random random) throws NegativeDeviationException {
		this(mean, mean/4, random);
	}
